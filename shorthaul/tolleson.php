<?php
$pageName = 'Tolleson, AZ - Short Haul';		
...
<section>
	...
	<div class="container primaryContainer space_Around med_Margin med_Margin-top">
		...
		<div style="margin: 0px 0px 20px 0px;" class="callout">
			...
			<p><b>Start at $16 an hour, up to 7 days a week</b></p></span>
		</div>
		<div style="margin: 0px 0px 20px 0px;" class="callout">	
	...
	<div class="container primaryContainer">
		<div>	
			<h2>Pay</h2>
			<ul>
				<li><b>$16/hour</b> starting pay</li> 
			</ul>
		</div>
		<div>
	...
	<div class="container primaryContainer">
		<div>	
			<h2>Work & Route</h2>
			<ul>
				<li><b>Driving Area:</b> Phoenix metro and surrounding area</li>
				<li><b>Hiring Area:</b> within 30 miles of Tolleson</li>
				<li><b>Days and Hours:</b> as needed 24/7; mainly evenings and early mornings</li>
				<li><b>Loads:</b> local refrigerated deliveries</li>
				<li><b>Home Time:</b> most days</li>
			</ul> 
		</div>
		<div>
			<style>	
	...
	<script>
		$(function(){
			$(".mapcontainer").mapael({
				...
				plots: {
  				'Tolleson': { type: "circle", size: 20, latitude: 33.450042, longitude: -112.259321, attrs: { fill: "#a35553" }, attrsHover: { fill: "#a35553" }, tooltip: {content: "Tolleson, AZ,<br>50 Mile Radius"} },
				}
			});
		});
	</script>
