<?php
$pageName = 'Centralia, MO - Short Haul Auger Trailer';
...
<section>
	...
	<div class="container primaryContainer space_Around med_Margin med_Margin-top">
		...
		<div style="margin: 0px 0px 20px 0px;" class="callout">
			...
			<p><b>Earn 35 to 38 CPM, plus $18 per load</b></p></span>
		</div>
		<div style="margin: 0px 0px 20px 0px;" class="callout">
	...
	<div class="container primaryContainer">
		<div>
			<h2>Pay</h2>
			<ul>
				<li><b>35 CPM</b> for days</li>
				<li><b>38 CPM</b> for nights</li>
				<li><b>$18</b> per load</li>
				<li><b>Detention:</b> $13/hour (after 1.5 hours)</li>
			</ul>
			<h2>Work & Route</h2>
			<ul>
				...
				<li><b>Loads:</b> average of two and a half a day; average length of 127 miles</li>
				<li><b>Driving Area:</b> within 150 miles of Centralia Mill</li>
				<li><b>Hiring Area:</b> within 50 miles of Centralia, MO</li>
	...
	<script>
		$(function(){
			$(".mapcontainer").mapael({
				...
				plots: {
  				'Centralia': { type: "circle", size: 20, latitude: 39.210318, longitude: -92.137953, attrs: { fill: "#a35553" }, attrsHover: { fill: "#a35553" }, tooltip: {content: "Centralia, MO<br>50 Mile Radius"} },
				}
			});
		});
	</script>
