<?php
$pageName = 'Greeley, CO - Short Haul';		
...
<section>
	...
	<div class="container primaryContainer space_Around med_Margin med_Margin-top">
		...
		<div style="margin: 0px 0px 20px 0px;" class="callout">
			...
			<p><b>Earn $800 to $1,000 a week</b></p></span>
		</div>
		<div style="margin: 0px 0px 20px 0px;" class="callout">	
	...
	<div class="container primaryContainer">
		<div>	
			<h2>Pay</h2>
			<ul>
				<li><b>$20/Hour:</b> 40 to 50 hours a week</li>
			</ul>
			...
			<ul>
				...
				<li><b>Loads and Locations:</b> liquid feed and tallow/whey trailers to feed lots; hides containers from Greeley or Scotts Bluff, NE, to Denver rail yard; short hauls across town</li>
				<li><b>Recruiting Area:</b> within 30 miles of Greeley</li>
			</ul> 
		</div>
		<div>
			<style>	
