<?php
$pageName = 'Green Bay, WI - Cattle Haul';		
	...
	<div class="container primaryContainer">
		<div>	
			...
			<ul>
				...
				<li><b>Driving Region:</b> sale barns and farmer feeders in WI, MN, IA, IL, and MI</li>
				<li><b>Hiring Area:</b> within 30 miles of Green Bay terminal</li>
