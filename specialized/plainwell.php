<?php
$pageName = 'Plainwell, MI - Cattle Haul';		
...
<section>
	...
	<div class="container primaryContainer">
		<div>	
			...
			<ul>
				<li><b>41 CPM</b></li>
				<li><b>Daily Inspections:</b> $3</li>
				<li><b>Wait Time:</b> $12/hour (after 90 minutes)</li>
				<li><b>Loading/Unloading:</b> $10</li>
				<li><b>Non-Driving Rate:</b> $12/hour</li>
			</ul>
			<h2>Work & Route</h2>
			<ul>
				<li><b>Average Miles:</b> 400 to 600 a day</li>
				<li><b>Driving Region:</b> various local feed yards</li>
				<li><b>Hiring Area:</b> within 50 miles of Plainwell, MI</li>
		...
		<div>
			...
			<ul>
				...
				<li><b>Rider Policy:</b> after 90 days</li>
	...
	<script>
		$(function(){
			$(".mapcontainer").mapael({
				...
				plots: {
  				'Plainwell, MI': { type: "circle", size: 20, latitude: 42.440035, longitude: -85.648903, attrs: { fill: "#a35553" }, attrsHover: { fill: "#a35553" }, tooltip: {content: "Plainwell, MI<br>50 Mile Radius"} },
				}
			});
		});
	</script>
