<?php
$pageName = 'Oakwood, GA - Dedicated Chicken Live Haul';
	...
	<div class="container primaryContainer">
		<div>
			...
			<ul>
				...
				<li><b>Bonuses:</b> for safety and retention</li>
			</ul>
			<h2>Work & Route</h2>
			<ul>
				<li><b>Pickups and Deliveries:</b> from chicken farms to the Gainesville plant</li>
				...
				<li><b>Hiring Areas:</b> within 50 miles of the terminal in Oakwood</li>
	...
	<script>
		$(function(){
			$(".mapcontainer").mapael({
				...
				plots: {
  				'Oakwood': { type: "circle", size: 20, latitude: 34.227602, longitude: -83.884345, attrs: { fill: "#a35553" }, attrsHover: { fill: "#a35553" }, tooltip: {content: "Oakwood, GA<br>50 Mile Radius"} },
				}
			});
		});
	</script>
