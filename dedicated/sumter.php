<?php
$pageName = 'Sumter, SC - Dedicated Chicken Live Haul';
...
<section>
	...
	<div class="container primaryContainer space_Around med_Margin med_Margin-top">
		...
		<div style="margin: 0px 0px 20px 0px;" class="callout">
			...
			<p><b>Earn an average of $150 a day.</b></p></span>
		</div>
		<div style="margin: 0px 0px 20px 0px;" class="callout">
	...
	<div class="container primaryContainer">
		<div>
			<h2>Pay</h2>
			<ul>
				<li><b>Paid by the Load:</b> average of $150 per day</li>
				<li><b>15 CPM Increase:</b> for round trips over 60 miles</li>
				<li><b>Detention:</b> $10/hour</li>
				<li><b>Breakdown:</b> $10/hour (up to 8 hours a day)</li>
			</ul>
			<h2>Work & Route</h2>
			<ul>
				<li><b>Pickups and Deliveries:</b> from chicken farms to the Sumter plant</li>
				<li><b>Days and Hours:</b> Sunday through Thursday; some weekends; start times from 1pm - 3am</li>
				<li><b>Equipment:</b> 2017 Kenworths; some slip-seat</li>
				<li><b>Hiring Areas:</b> within 40 miles of Pilgrims plant in Sumter</li>
		...
		<div>
			...
			<ul>
				...
				<li><b>Bonuses:</b> safety and retention</li>
			</ul>
			<style>
				.mapcontainer{
					position: relative;
	...
	<script>
		$(function(){
			$(".mapcontainer").mapael({
				...
				plots: {
  				'Sumter, SC': { type: "circle", size: 20, latitude: 33.920435, longitude: -80.341469, attrs: { fill: "#a35553" }, attrsHover: { fill: "#a35553" }, tooltip: {content: "Sumter, SC<br>40 Mile Radius"} },
				}
			});
		});
	</script>
